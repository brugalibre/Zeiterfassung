...
/**
 * A Class which is annotated with this annotation declares that it contains Java-FX-content such as FXML or CSS files which are located in the same folder as the page
