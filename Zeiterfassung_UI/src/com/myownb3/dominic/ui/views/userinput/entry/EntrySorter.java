 ...
 * 
 */
package com.myownb3.dominic.ui.views.userinput.entry;
...
public class EntrySorter implements Comparator<Entry>
{
    ...
    * Return 1 if the firstEntry was used more recently then the second one
    * Return -1 if the secondEntry was used more recently then the first one
   ...
   @Override
   public <U extends Comparable<? super U>> Comparator<Entry> thenComparing (Function<? super Entry, ? extends U> arg0)
   {
      return null;
   }
