 ...
 * 
 */
public abstract class AbstractCell extends Drawable<String> implements Cell {
    protected static final int ADDITIONALLY_HEIGHT;
    protected static final int ADDITIONALLY_WIDTH;
    protected static final int CELL_MARGIN; // space between the border of the cell and it's value
    ...
    public AbstractCell(String value, Font f, Color c, PositionContraints cont, ParentComponent parent) {
	super(value, parent);
	...
	this.height = com.myownb3.dominic.ui.util.Util.getTextHight(this) + ADDITIONALLY_HEIGHT;
	this.width = com.myownb3.dominic.ui.util.Util.getTextLength(value, this) + ADDITIONALLY_WIDTH;
    ...
    public AbstractCell(String value, ParentComponent parent) {
