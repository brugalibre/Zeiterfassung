...
/**
 * The {@link ToolTip} is used as tool-tip for all {@link Drawable} objects. It paints any String value as it's tool-tip. It is possible to paint a multi-line tool-tip
 * @author Dominic
 *
 */
public class ToolTip extends Drawable<String>
{
   public static final String NEW_LINE_MARKER = "\n"; // at each such marker, the given string is separated, and continued on the next line
   ...
   /*
    * If the tool-tip is a single line value, then it's length is returned. If the tool-tip consist
    * of multiple line, the maximal length of each line is returned
    */
