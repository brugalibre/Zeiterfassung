...
public interface Renderer
{
    ...
    * @return the {@link Shape} of this renderer. If <code>setBounds</code> has not been called before, the bounds computed from <code>getPreferredSize</code> is returned.
    */
