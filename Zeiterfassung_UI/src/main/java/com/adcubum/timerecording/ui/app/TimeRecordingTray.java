...
public class TimeRecordingTray implements LoginCallbackHandler {
   ...
   private void sendBookedBusinessDayIncrementsRunnable() {
      ...
      sendBookedBusinessDayIncrementsMenuItem.setEnabled(isSendBookedBusinessDayIncrementsEnabled());
   }

   private static boolean isSendBookedBusinessDayIncrementsEnabled() {
      return TimeRecorder.INSTANCE.getBusinessDay()
              .getIncrements()
              .stream()
