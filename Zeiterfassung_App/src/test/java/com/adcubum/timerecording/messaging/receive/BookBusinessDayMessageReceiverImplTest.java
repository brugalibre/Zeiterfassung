...
class BookBusinessDayMessageReceiverImplTest {
   ...
   private static class TestCaseBuilder {
      ...
      private TestCaseBuilder build() {
         ...
         this.bookBusinessDayMessageReceiver = new BookBusinessDayMessageReceiverImpl(timeRecorder, ticketBacklog, Settings.INSTANCE);
      ...
      private void mockTicketBacklog(BusinessDay businessDay) {
         BookSenderReceiverId bookReceiverId = Settings.INSTANCE.getSettingsValue(ValueKeyFactory.createNew("BookBDaySenderReceiverId", BookSenderReceiverId.class));
