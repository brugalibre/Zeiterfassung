...
/**
 * Defines a period, that begin with the {@link #beginTimeStamp} and ends with the {@link #endTimeStamp}.
 * The time between these two time-stamps can be calculated by invoking the {@link #getDuration()} or {@link #getDuration(TIME_TYPE)} method.
 * @author Dominic
 *
 */
public class TimeSnippet
{
   ...
   /**
    * Return the amount of minutes between the start, and end-point. If there is no ent-point yet,
    * a new end-point at the most current now is created
    * @return the amount of minutes between the start, and end-point 
    */
