...
public class BusinessDayImpl implements BusinessDay {
   ...
   public BusinessDay flagBusinessDayIncrementAsBooked(UUID id) {
      return changeBusinessIncrementById(id, businessDayIncrement -> businessDayIncrement.flagAsBooked());
   }

   @Override
   public BusinessDay flagBusinessDayIncrementAsSent(UUID id) {
      return changeBusinessIncrementById(id, businessDayIncrement -> businessDayIncrement.flagAsSent());
   }
